...
Shopware.Service('cmsService').registerCmsElement({
    name: 'fh-accordion',
    label: 'fh.elements.accordion.label',
    component: 'sw-cms-element-fh-accordion',
    configComponent: 'sw-cms-element-config-fh-accordion',
    previewComponent: 'sw-cms-element-preview-fh-accordion',
    defaultConfig: {
        numberOfItems: {
            source: 'static',
            value: 3
