import template from './fh-product-media-form.html.twig';
import './fh-product-media-form.scss';

const { Component, Context, Utils } = Shopware;
const { isEmpty } = Utils.types;
const { Criteria } = Shopware.Data;

Component.extend('fh-product-media-form', 'sw-product-media-form', {
  template,
  ...
  computed: {
    ...
    embeddedVideoMediaUploadTag() {
      return this.product.id + '-fh-product-video';
    },
