...
namespace FULLHAUS\MerchantFinder\Migration;
...
class Migration1565395385Merchant extends MigrationStep
{
    ...
    {
        $query = <<<SQL
CREATE TABLE IF NOT EXISTS `fh_merchant` (
    ...
    `merchant_group_id` TINYINT(6),
    `merchant_type_id` TINYINT(2),
    `custom_fields` JSON,
...
SQL;
        ...
        $query = <<<SQL
CREATE TABLE IF NOT EXISTS `fh_zipcode` (
